...
import torontomu.ca.stocktransactions.helper.FinancialDataXML;
import torontomu.ca.stocktransactions.helper.FinancialDataWrapper;
import torontomu.ca.stocktransaction.business.StockBusiness;
import torontomu.ca.stocktransactions.helper.UserNotFoundException;
@Path("stock")
public class StockResource {
    
    private StockBusiness stockbusiness = new StockBusiness();
   ...
   public Response processTrade(JAXBElement<TradeRequest> tradeRequestElement) {
    ...
    try {
        ...
        boolean tradeSuccess = stockbusiness.processTrade(
        ...
        availableFunds = stockbusiness.getAvailableFunds(tradeRequest.getPrimaryUser());
    ...
    public Response getFinancialData() {
        FinancialDataWrapper financialDataWrapper = stockbusiness.getAllFinancialData();
